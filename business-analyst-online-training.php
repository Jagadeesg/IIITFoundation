...
if(isset($_POST['reqdemo_btn']))
{
	...
	$country=$country.$phone;
			...
			{
				echo "<script>
				window.location.href='business-analyst-online-training.php';
			</script>";
			}
			else
			{
...
<html>
	<head>
		<title>Business Analyst Online Training | Business Analyst Certification</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta name="keywords" content="business analyst online training,business analyst course,business analyst certification,cbap certification,business analyst,business analyst online training in usa,ba online training,online training courses,certified business analysis professional,business analyst qualifications."/>
		<meta name="description" content="COEPD is an IIBA endorsed education provider for Business Analyst Online Training. 40 PD hours will be awarded after the training."/>
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
 <link rel="canonical" href="https://www.coepd.us/business-analyst-online-training.html" />
...
<div class="col-md-12 ">
	 ...
	 <div class="container-fluid page-heading">
		<div class="row">
			<h1>BUSINESS ANALYST ONLINE TRAINING</h1>
		</div>
	</div> 
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-2 col-xl-2  page-heading" id="page-heading">
	
			<div class="page-theme btn-group-vertical">
				<ul>
					<li id="overview" class="button btn-info btn btn-lg active" type="button">Overview</li>
					<li id="BA" class="button btn-info btn btn-lg" type="button">Who can become a BA</li>
					<li id="highlights" class="button btn-info btn btn-lg" type="button">Training Highlights</li>
					<li id="certifications" class="button btn-info btn btn-lg" type="button">Certifications Offered</li>
					<li id="career" class="button btn-info btn btn-lg" type="button">Career Growth</li>
				</ul>
			</div>
			<div class="col-sm-12 col-md-12 col-lg-3 col-xl-3  page-heading">
				<div class="page-theme1 btn-group-vertical">
					<ul class="page-theme-mobile">
						<li id="overview1" class="button btn btn-info btn-sm">Overview</li>
						<li id="BA1" class="button btn btn btn-info btn-sm">Who can become a BA</li>
						<li id="highlights1" class="button btn btn-info btn btn-sm">Training Highlights</li>
						<li id="certifications1" class="button btn btn-info btn btn-sm">Certifications Offered</li>
						<li id="career1" class="button btn btn btn-info btn-sm">Career Growth</li>
					</ul>
				</div>
			</div>
		</div>
		<div class="col-sm-12 col-md-12 col-lg-1 col-xl-1 triangle">
					<div class="triangle-shape-main">
						...
						<div class="triangle-shape3">
							
						</div>
						<div class="triangle-shape4">
							
						</div>
						<div class="triangle-shape5">
...
<script>
// var b1 = document.getElementById("overview");
// var b2 = document.getElementById("BA");
// var b3 = document.getElementById("highlights");
// var b4 = document.getElementById("certifications");
// var b5 = document.getElementById("career");

// b1.onclick = function() {
     // b1.style.background = "#CD7F32";
     // b2.style.background = "#1dbad3"; 
	 // b3.style.background = "#1dbad3";
	 // b4.style.background = "#1dbad3";	
     // b5.style.background = "#1dbad3";	 
// }

// b2.onclick = function() {
     // b1.style.background = "#1dbad3";
     // b2.style.background = "#CD7F32";  
	 // b3.style.background = "#1dbad3";
	 // b4.style.background = "#1dbad3";
	 // b5.style.background = "#1dbad3";	
// }
...
// b5.onclick = function() {
	 ...
	 // b3.style.background = "#1dbad3";
	 // b4.style.background = "#1dbad3";	
     // b5.style.background = "#CD7F32";  
// }

var b6 = document.getElementById("overview1");
var b7 = document.getElementById("BA1");
var b8 = document.getElementById("highlights1");
var b9 = document.getElementById("certifications1");
var b10 = document.getElementById("career1");

b6.onclick = function() {
     b6.style.background = "#CD7F32";
     b7.style.background = "#1dbad3";
	 b8.style.background = "#1dbad3";
	 b9.style.background = "#1dbad3";	
     b10.style.background = "#1dbad3";	 
}

b7.onclick = function() {
     b6.style.background = "#1dbad3";
     b7.style.background = "#CD7F32";  
	 b8.style.background = "#1dbad3";
	 b9.style.background = "#1dbad3";
	 b10.style.background = "#1dbad3";	
}
...
b10.onclick = function() {
	 ...
	 b8.style.background = "#1dbad3";
	 b9.style.background = "#1dbad3";	
     b10.style.background = "#CD7F32";  
}

</script>		

<!-- var header = document.getElementById("page-theme"); -->
...
<!-- } -->
		...
		<div class="col-sm-12 col-md-7 col-lg-6 col-xl-6">
			...
			<div class="overview">
				<p class="nav-heading1 baol-heading">Overview</p>
				<p>COEPD extends online education and training opportunities to individuals and professionals 
				across the world. Now, from almost anywhere around the globe, professionals can increase their knowledge and 
				skills to mitigate the needs of the Global market within the vertical of business analysis through easy accessibility &
				engaging online training opportunities. In today’s complex business world, an organization’s adaptability, agility, and 
				ability to manage constant change requests through innovation can be keys to success and that’s where business analysis comes 
				into picture. The goal of an Organization is achieved through projects that converts the customer needs into services, new products
				and profits. Business analysts can make it all happen more efficiently and effectively.</p>
				<p>We are proud to offer online accessible trainings in flexible formats that bridge theory and practical knowledge for all the enthusiastic 
				professionals, who are keenly interested in getting into this BA role. We conduct online training sessions for our participants which is 
				Interview oriented, Job oriented and Industry oriented and exposure to all the Business Analysis knowledge areas which helps to develop 
				Analysis skills to work and understand the principles of Business analysis.</p>
			</div>	
			<div class="ba">
				<p class="nav-heading1 baol-heading">Who can become a BA</p>
				<p>Resources who have Minimum graduation, Good communication Skills, Work experience in any process or a project, able to manage 
				a team and most importantly acquiring BA skills and knowledge that you'll need to land in a Business Analyst job.</p>
			</div>
			<div class="highlights">
				<p class="nav-heading1 baol-heading">Training Highlights</p>
				<ul type="circle">
					<li>Screen Sharing/Presentation Sharing though Citrix Go To Meeting</li>
					<li>Detail Explanation with practical and Real time examples</li>
					<li>Test the understanding of participants through daily Assignments</li>
					<li>Every session is supported by discussion notes, study material in PDF format and assignments</li>
					<li>Share live session recordings</li>
					<li>Access to COEPD web portal</li>
					<li>Practice 90+ Business Analyst online prep exams to improve your knowledge</li>
					<li>Blog writing and Forums participation</li>
					<li>End to End practice on a project</li>
					<li>Virtual experience with training techniques and tools</li>
					<li>Sharing tools and practice videos</li>
					<li>Adjustable sessions as per the participants receiving capability</li>
					<li>Personal assistance in any issues that occur on software installation</li>
					<li>Assist in Resume preparation</li>
				</ul>
			</div>
			<div class="certifications">
				<p class="nav-heading1 baol-heading">Certifications Offered</p>
				<p>After completing your Business Analyst online training course, in order to meet the growing demands of current Market 
				place you can opt for respected industry certifications from below globally recognized certification bodies like IIBA, IVY Global Academy, 
				PMI-PBA, for BA Certifications.</p>
				<ul>
					<li>IIBA (International Institute of Business Analysis) provides the following certificates.
						<ul>
							<li>ECBA - Entry Certificate in Business Analysis.</li>
							<li>CCBA - Certification of Competency in Business Analysis.</li>
							<li>CBAP - Certified Business Analysis Professional.</li>
						</ul>
					</li>
				</ul>
				<b style="color:#4f8dc6;">Note:</b><p>Participants who completed our IT Business Analyst online training program will be rewarded with 40 PD hours certificate - Endorsed by IIBA which can be used to write any IIBA certifications.</p>
				<ul>
					<li>IVY Global Academy Certifications
						<ul>
							<li>CITBA – Certified IT Business Analyst</li>
							<li>CITBAP – Certified IT Business Analyst – Practitioner</li>
							<li>CITSM – Certified IT Scrum Master</li>
							<li>CITPO – Certified IT Product Owner</li>
							<li>CITSD – Certified IT Scrum Developer</li>
						</ul>
					</li>
				</ul>
			</div>
			<div class="career">
				<p class="nav-heading1 baol-heading">Career Growth</p>
				<p>In the current market place Business Analyst plays an important role in the IT companies. Participants who have completed their 
				Training with us have gained the required skills and knowledge to survive in the competitive job market.The Business Analyst profession has many 
				opportunities for growth depending on your interests, few are below: Junior Business Analyst --> Senior Business Analyst --> Lead Business Analyst
				--> SME --> Project Manager --> Enterprise/Business Architect --> CIO</p>
			</div>
			</div>
		</div>
		<div class="col-sm-12 col-md-5 col-lg-3 col-xl-3 floating-box"> 
			<?php
			include("dbconnect.php");
