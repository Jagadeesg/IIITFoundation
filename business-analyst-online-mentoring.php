...
if(isset($_POST['reqdemo_btn']))
{
	...
	$country=$country.$phone;
		...
		$register="insert into request_demo(name,email,country,subject,DateTime) 
			...
			{
				echo "<script>
				window.location.href='ba-mentoring.php';
			</script>";
			}
			else
			{
...
<html>
	<head>
		<title>BA Mentoring | Business Analyst Online Mentoring | On-Job Support</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta name="keywords" content="BA Mentoring,Business Analyst Online Training,On-Job Support,BA Online Mentoring,business analyst,business analyst course online,business analyst training."/>
		<meta name="description" content="COEPD imparts real-time knowledge through working on UML Diagrams , Tools and BRD , SRS Documents on one Project and makes you interview ready."/>
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
 <link rel="canonical" href="https://www.coepd.us/business-analyst-online-mentoring.html" />
...
<div class="col-md-12 ">
	 ...
	 <div class="container-fluid page-heading">
		<div class="row">
			<h1>BUSINESS ANALYST ONLINE MENTORING</h1>
		</div>
	</div> 
	...
	<div class="row">
		<div class="col-sm-12 col-md-7 col-lg-9 col-xl-9">
			<div class="page-content1">
				<b>Welcome to the Mentoring world of Business Analysis.</b><br><br>
				<p>Welcome to the Mentoring Program for Business Analysis. Congratulations on completion of your Business Analyst online training. Now it’s 
				time to implement what we have learned in the Training. COEPD provides Exclusive Mentoring program post training where our Mentors will help 
				you practice and master the skill sets of a Business Analyst to become job ready.</p>
				<p>The main objective of this Mentoring sessions is to emphasize the importance of personal care we take to mentor our participants to gain 
				hands on experience and successfully achieve their job as a business analyst. By the time the sessions are completed, you will be able to 
				understand the importance of work culture, situational handling, Task handling, Hands on documentation and tools and Day to Day work deliveries.</p>
				<img src="img/infographics.png" width="600" class="img-fluid" alt="image infographics" style=" display: block;margin-left: auto;margin-right: auto;"/>
				<b>Activities involved:</b>
				<ul>
					<li>Practice UML diagrams and Tools usage.</li>
					<li>Practice on different case studies from various domains</li>
					<li>Wireframe & prototyping Tool usage.</li>
					<li>Review and Feedback on the each assignment</li>
					<li>Blog and Forum participation importance</li>
					<li>Working with BRD document of the concerning project</li>
					<li>Working with RTM document of the concerning project</li>
					<li>Working with FRD document of the concerning project</li>
					<li>Writing Test cases for the same project requirements</li>
					<li>Assistance with technical skills like MySQL, Ms- Excel.</li>
					<li>Guidance on frequently asked questions or concepts.</li>
					<li>Help in Resume preparation and reviews</li>
