...
if(isset($_POST['reqdemo_btn']))
{
	...
	$country=$country.$phone;
			...
			{
				echo "<script>
				window.location.href='Certified-IT-Business-Analyst.php';
			</script>";
			}
			else
			{
...
<html>
	<head>
		<title>IT Business Analyst Certification | CITBA | IIBA Certificate</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta name="keywords" content="it business analyst certification,citba,ba certification,certified business analysis professional,ivy global Academy,iiba certification,business analyst certification online,business analyst certification."/>
		<meta name="description" content="COEPD is Authorized Training Partner (ATP) of IVY Global Academy. With BA Training Candidate can write and clear IT Business Analyst Certification."/>
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
 <link rel="canonical" href="https://www.coepd.us/certified-it-business-analyst.html" />
...
<div class="col-md-12 ">
	 ...
	 <div class="container-fluid page-heading">
		<div class="row">
			<h1>CITBA – CERTIFIED IT BUSINESS ANALYST</h1>
		</div>
	</div> 
	...
	<div class="row">
		<div class="col-sm-12 col-md-7 col-lg-9 col-xl-9">
			<div class="page-content1">
				<b>Certified IT Business Analyst (CITBA)</b><br>
				<p><strong>Exam Code :</strong>CITBA</p>
				<img class="img-fluid" src="img/CITBA.png"  alt="CITBA"/>
				<p><strong>About Exam Course</strong></p>
				<p>Business Analyst plays a vital role in IT Projects and through successful implementation. Business Analyst will understand the Business process, identifies the areas of improvement or problem Areas and will suggest a suitable IT Solution for the GAPs identified. A Business Analyst will elicit the requirements from the stakeholders, does the analysis and confirms the requirements. BA will track the requirements during development phase and in testing phase, makes sure that UAT is conducted successfully and sign off on the project closure document is done. </p>
				<p>For all the professionals aspiring to get into Business Analyst role and who are already playing the role of BA without having a BA designation, Get certified as CITBA to get formal recognition as a Business Analyst.</p>
				<p><strong>Target Audience</strong></p>
				<p>Any professional who wants to get into a BA role in entry level or practicing BA without being designated as BA can take up this Certification to formally get recognized.</p>
				<strong>Register for Exam</strong>
				<p>CITBA –Certified IT BA - USD 119</p>
              	<img src="img/CertificateCITBA.jpg" width="600" alt="CITBA-Certificate" class="img-fluid" style=" display: block;margin-left: auto;margin-right: auto;"/>
			</div>
		</div>
