...
if(isset($_POST['reqdemo_btn']))
{
	...
	$country=$country.$phone;
		...
		$register="insert into request_demo(name,email,country,subject,DateTime) 
			...
			{
				echo "<script>
				window.location.href='refund-policy.php';
			</script>";
			}
			else
			{
...
<html lang="en">
<head>
	  <title>COEPD.US-Refund Policy</title>
...
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
	  ...
	  <meta name="viewport" content="width=device-width, initial-scale=1" />
	   <meta name="description" content="Participants shall pay the course fee to COEPD as agreed. If the participant wants the refund of money after attending 2 sessions,COEPD will not provide any refund"/>
<link rel="canonical" href="https://www.coepd.us/refund-policy.html" />
	...
	<div class="row">
		<div class="col-sm-12 col-md-7 col-lg-9 col-xl-9">
			<div class="page-content1">
				...
				<b>Refund-Online training</b>
				<ul>
					<li>Participants shall pay the course fee to COEPD as agreed.</li>
					<li>Once registered for the training sessions, and if the participant wants to discontinue from the training due to any reason within 2 sessions, COEPD has right to deduct the fee to cover the costs of demo sessions, training expenses, administrative costs and server usage.</li>
					<li>If the participant wants the refund of money after attending 2 sessions, COEPD will not provide any refund.</li>
				</ul>
				<b>Refund- Cancellation:</b>
				<ul>
					<li>Coepd reserves the right to postpone/cancel the training, because of insufficient enrollments, instructor illness or Catastrophic events (like floods, earthquakes, political instability, etc)</li>
				...
				<b>Refund-Duplicate payment:</b>
				<ul>
					<li>Refund of the duplicate payment made by the participant will be processed via the same source (original method of payment) in 10 working days post intimation by the participant and after approval by COEPD.</li>
				</ul>
			</div>
		</div>
			...
			<div class="floating-box2">
					...
					<!-- Trigger the modal with a button -->
						<li><a data-toggle="modal" data-target="#quick">Who is a Business Analyst?</a></li>						
							  ...
							  <div class="modal fade" id="quick" role="dialog">
								<div class="modal-dialog modal-lg">
								  ...
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">Who is a Business Analyst?</h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
						...
						<li><a data-toggle="modal" data-target="#quick1">Where and what is the importance of a business analyst ? </a></li>
						 <!-- Modal -->
							  <div class="modal fade" id="quick1" role="dialog">
								<div class="modal-dialog modal-lg">
								
								  <!-- Modal content-->
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">Where and what is the importance of a business analyst ? </h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
						...
						<div class="modal fade" id="quick2" role="dialog">
								<div class="modal-dialog modal-lg">
								
								  <!-- Modal content-->
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">What are the core skills of a business analyst ? </h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
						...
						<div class="modal fade" id="quick3" role="dialog">
								<div class="modal-dialog modal-lg">
								
								  <!-- Modal content-->
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">What is business analysis ? </h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
									  <ul class="quick1">
						...
						<div class="modal fade" id="quick4" role="dialog">
								<div class="modal-dialog modal-lg">
								
								  <!-- Modal content-->
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">Who can become a Business analyst ?</h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
									  <ul class="quick1">
						...
						<li><a data-toggle="modal" data-target="#quick5">What are the Prerequisites to become a BA ? </a></li>
							<div class="modal fade" id="quick5" role="dialog">
								<div class="modal-dialog modal-lg">
								
								  <!-- Modal content-->
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">What are the Prerequisites to become a BA ? </h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
						...
						<div class="modal fade" id="quick6" role="dialog">
								<div class="modal-dialog modal-lg">
								
								  <!-- Modal content-->
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">Skill set required by a BA ? </h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
									<b>8 Skill Areas</b>
						...
						<li><a data-toggle="modal" data-target="#quick7">What is the difference between Business Analyst & SME ? </a></li>
							<div class="modal fade" id="quick7" role="dialog">
								<div class="modal-dialog modal-lg">
								
								  <!-- Modal content-->
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">What is the difference between Business Analyst & SME ?  </h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
									  <ul class="quick1">
						...
						<div class="modal fade" id="quick8" role="dialog">
								<div class="modal-dialog modal-lg">
								
								  <!-- Modal content-->
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">What are the BA Certifications available and eligibility criteria ? </h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
									  <ul class="quick1">
						...
						<div class="modal fade" id="quick9" role="dialog">
								<div class="modal-dialog modal-lg">
								
								  <!-- Modal content-->
								  <div class="modal-content">
									<div class="modal-header">
									  <h4 class="modal-title">What are the major roles and responsibilities of a BA ? </h4>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
