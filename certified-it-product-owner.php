...
if(isset($_POST['reqdemo_btn']))
{
	...
	$country=$country.$phone;
			...
			{
				echo "<script>
				window.location.href='Certified-IT-product-owner.php';
			</script>";
			}
			else
			{
...
<html>
	<head>
		<title>Certified IT Product Owner | CITPO | IIBA Certificate</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta name="keywords" content="Certified IT Product Owner,CITPO,iiba certification,certified scrum product owner,scrum product owner,scrum master certification cost,it product owner,product owner responsibilities,ivy global Academy,product owner role,business analyst certification,iiba certification."/>
		<meta name="description" content="COEPD BA Training gives eligibility for CITPO - Certified IT Product Owner, an Internationally Recognised Certificate on Agile/Scrum Projects."/>
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
 <link rel="canonical" href="https://www.coepd.us/certified-it-product-owner.html" />
...
<div class="col-md-12 ">
	 ...
	 <div class="container-fluid page-heading">
		<div class="row">
			<h1>CERTIFIED IT PRODUCT OWNER (CITPO)</h1>
		</div>
	</div> 
	...
	<div class="row">
		<div class="col-sm-12 col-md-7 col-lg-9 col-xl-9">
			<div class="page-content1">
				<b>Certified IT Product Owner (CITPO)</b>
                <p><strong>Exam Code : </strong>CITPO0001</p>
                <img src="img/CITPO.png" alt="CITPO" class="img-fluid"/>
                <p><strong>About Exam Course</strong></p>
                <p>The Product Owner role is a broad and unique role in Scrum which is a combination of all the challenging aspects of traditional Project Manager and Product Manager Roles. Moreover, Scrum Product Owner represents the customer point of view in a Scrum project. It needs to be thoroughly integrated with the overall Software Development and Delivery Teams and Processes to ensure maximum added value for each and every Product Release.</p>
                <p>Whether, you act as a Scrum Product Owner or not in your Scrum team, as long as you’re directly working with your customers it is fundamentally important for you to understand the role of Scrum Product Owner in order to be utmost helpful for your customers and to create the maximum added value for them. </p>
                <strong>Note :</strong>The Certified IT Product Owner (CITPO) – Certification has no pre-requisites.
                <p><strong>Target Audience</strong></p>
                <p>This certification is especially suitable for anyone in the corporate structure dealing with rapidly changing demands and decision-making responsibilities. In an organization, these roles might include:</p>
                <ul>
                  <li>Stakeholders</li>
                ...
                <p>CITPO - Certified IT Product Owner – USD 119</p>
                <img src="img/CertificateCITPO.jpg" width="600" alt="CITPO-Certificate" class="img-fluid" style=" display: block;margin-left: auto;margin-right: auto;"/>
