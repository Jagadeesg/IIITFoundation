...
<html lang="en">
<head>
	<title>Business Analyst Training | Business Analyst Online Training</title>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1" />
	  <meta name="keywords" content="business analyst training,business analyst online training,business analyst,ba training,business analyst certification,business analysis,iiba certification,cbap,ba certification,online classes."/>
	  <meta name="description" content="COEPD provides finest quality Business Analyst Training to IT/ Non-IT professionals across the globe. Call us +1 469-287-7949"/>
	  <link rel="stylesheet" href="css/font-awesome.min.css" />
<link rel="canonical" href="https://www.coepd.us/index.html" />
...
type = ""; e.parentNode.insertBefore($, e)
       })(document, "script");
   </script>
...
<header>
	...
	<div class="header-list">
		<ul>
			...
			<div class="phone">
				<img src="./img/call.png" alt="mobileicon"/>9346024593
			</div>
			<div class="email">
				<img src="./img/email.png" alt="emailicon"/>contatus@iitfoundation.org
			</div>
...
<div class="back-image">
	<img id="g1" src="img/boy.png" alt="boy">
</div>

<div class="back-image2">
	<img id="g2" src="img/girl.png" alt="girl">
</div>
<div class="container">
  <!-- The Modal -->
  <div class="modal fade" id="myModal" tabindex="-1">
   ...
   <div id="home" style="background: url('img/background.jpg');">
<?php 
	include("dbconnect.php");
			$select_trainingdetails="select * from scrolltrainingdetails_tbl";
			$query=mysqli_query($conn,$select_trainingdetails);

			while($trainingdetails=mysqli_fetch_assoc($query)){
			
			?>
   	   <div class="container">
   	   	<marquee behavior="scroll" style="margin-top: 10px;color: white;"  scrollamount="4" onmouseover="this.stop();"
           onmouseout="this.start();"><h5><?php echo ($trainingdetails['trainingdetails_text']); }?></h5></marquee> </div>
				...
				<li data-target="#demo" data-slide-to="1"></li>
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="img/background.jpg" alt="Image" width="100" height="500" />
								<div class="carousel-caption">
									<div class="coepd1">
										<h3>WELCOME to IIT Foundation</h3>
										<p>We, the IIT Foundation, incorporates investments, insurance, the redistribution of risk, and other financial activities..</p>
										<p>The initiative to facilitate professionals from finest quality on trading.</p>
										<p>Our specialists will take care from the initial
										</p>
										<p>Our IIT foundation with share profits.</p>
										<p>Collection of financial transactions.</p>
									</div>
								  </div>   
								</div>
								<div class="carousel-item">
								  <img src="img/background.jpg"  width="1100" height="500" alt="imagebg"/>
								  <div class="carousel-caption">
									<div class="coepd2">
										<h3>WHY IIT Foundation?</h3>
										<ul class="arrows">
											<li>Make some startegy and analysis while trading.</li>
											<li>Increase profits and decrease risks</li>
											<li>Finance advisory,Transaction services and tax advisory used to decrease risks </li>
											<li>Make to know financial position</li>
											<li>How financial advisory spent its funds</li>
											<li>we have diffent options in payment </li>
											
										</ul>
										<span id="pdemo" style="padding-right:240px !important;">Want to known about trading free&nbsp;<a href="#" class="btn btn-warning btn-sm"> Demo</a></span>
									</div>
								  </div>   
								</div>
						</div> 
...
<div class="demo2" id="demo2">
	<div class="container demo-container">	
	  ...
	  <form  name="request_demo" method="post" id="location" action="index.php" onsubmit="reqdemo()">
...
<div class="padding sub-main">
	<div class="container-fluid">
		<div class="row ">
			<div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
				<div class="sub">	
					<div class="front">
						<a href="business-analyst-online-training.html">
						<img src="img/online.jpg" class="img-fluid" alt="online training image"/></a>
						<p class="flipheading">Advisory Services</p>

					</div>
					<div class="back">
						<a href="business-analyst-online-training.html">
						<img src="img/online2.jpg" class="img-fluid" alt="online training image" /></a>
						<a href="business-analyst-online-training.html">click here for more details</a>
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
				<div class="sub">	
					<div class="front">
						<a href="business-analyst-online-mentoring.html">
						<img src="img/mentor.jpg" class="img-fluid" alt="ba mentoring image"/></a>
						<p class="flipheading">Pool Share Money</p>
					</div>
					<div class="back">
						<a href="business-analyst-online-mentoring.html">
						<img src="img/ss.jpg" class="img-fluid" alt="ba mentoring image" /></a>
						<a href="business-analyst-online-mentoring.html">click here for more details</a>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
				<div class="sub">	
					<div class="front">
						...
						<img src="img/certi-01.png"   class="img-fluid" alt="certification image"/></a>
						<p class="flipheading">Organic Agro</p>
					</div>
					<div class="back">
						<a href="certifications.html">
						<img src="img/certi-02.png"  class="img-fluid" alt="certification image"/></a>
						<a href="certifications.html">click here for more details</a>
					</div>
...
<div class="padding">
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-8 col-md-6 col-lg-8 col-xl-3" >
				<p class="blog-heading"> IIT BLOG</p>
				<p class="b1">Increase your trade margin, earn in stock market, increase your sensex today, get advisor while trading-Robo can decrease your risk- risk advisory. Auto trading to increase profits, know the forcasts while trading .</p>
			</div>
			
			<div class="col-sm-4 col-md-6 col-lg-4 col-xl-3 ">
				<a target="_blank" href="http://blog.coepd.com"><img src="img/blog.jpg" class="img-responsive" alt="blog image" /></a>
			</div>
			
			<div class="col-sm-8 col-md-6 col-lg-8 col-xl-3 ">
				<p class="blog-heading">IIT FORUM<p>
				<p class="b2">Click in the below form to register. </p>
				</ul>
										<span id="pdemo" style="padding-right:240px !important;">Want to known about trading free&nbsp;<a href="#" class="btn btn-warning btn-sm"> Demo</a></span>
									</div>
			...
			<div class="col-sm-4 col-md-6 col-lg-4 col-xl-3 ">
				<a target="_blank" href="http://forum.coepd.com"><img src="img/forum.jpg" class="img-responsive" alt="forum image"/></a>
			</div>
		</div>
	</div>
</div>
