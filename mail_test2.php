...
if ( isset( $_REQUEST['sendemail']) ) {
	...
	$from = 'monali.coepd@gmail.com';
	$toemail = 'monali.coepd@gmail.com';
	$subject =  $_REQUEST['subject'];
	$message = $_REQUEST['myNumber'];
	if ( $from == "" || $toemail == "" ) {
...
<form id="mailform" name="mailform" method="post">
                  Name:<input type="text" name="myName" id="myName"><br><br>
                  Email:<input type="text" name="email" id="email"><br><br>
                  Phone number:<input type="text" name="myNumber" id="myNumber"><br><br>
                  Subject:<input type="text" name="subject" id="subject"><br><br>
	<input type="text" name="sendmethod" value="smtp" />
          <!--button type="button" id="sendemail" onclick="GoSend(); AutoSubject();">Send</button-->
	  <input type="submit" id="sendemail" name="sendemail" onclick="GoSend(); ">
