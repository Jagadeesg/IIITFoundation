...
<html lang="en">
<head>
	  <title>COEPD.US-Testimonial</title>
...
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
 ...
 <link rel="canonical" href="https://www.coepd.us/testimonials.html" />
 <meta name="description" content="Coepd Provide the real time experience and help to understand the Concepts in the right way."/>
...
<div class="demo2" id="demo2">
	<div class="container demo-container">	
		...
		<input type="text" id="name1" name="myName" placeholder="Your name.." required></div>
		<div class="col-md-12 ">
	...
	<!-- Start Testimonials content -->
		...
		<div class="col-sm-12 col-md-7 col-lg-9 col-xl-9">
			<div class="page-content1">
               <table class="table table-bordered table-responsive testimonials">
					<tbody>
						<?php
							...
							$totaltestimonials = "SELECT * FROM testimonials ORDER BY testimonial_id DESC";
							$allTestimonialResult = mysqli_query($conn, $totaltestimonials);
							$CountTestimonials = mysqli_num_rows($allTestimonialResult);
							$lastPage = ceil($CountTestimonials/$showRecordPerPage);
							$firstPage = 1;
							$nextPage = $currentPage + 1;
							$previousPage = $currentPage - 1;
							$testimonialSQL = "SELECT testimonial_id,testimonialstext, authorName 
							FROM `testimonials` ORDER BY testimonial_id DESC LIMIT $startFrom, $showRecordPerPage";
							$testimonialResult = mysqli_query($conn, $testimonialSQL);
							?>
						<?php
							while($testimonial = mysqli_fetch_assoc($testimonialResult)){
								?>
							<tr>
								<td ><?php echo $testimonial['testimonialstext']; ?>
									<span class="test pull-right">- <?php echo $testimonial['authorName']; ?></span></td>
							</tr>
								<?php } ?>
						</tbody>
			    </table>
