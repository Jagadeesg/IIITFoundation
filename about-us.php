...
<html lang="en">
<head>
	  <title>Business Analyst Training | BA Training in Hyderabad</title>
<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta name="keywords" content="Business Analyst Training, BA Training in Hyderabad, Business Analyst Certification, Coepd, Business Analyst, BA Training Courses, BA Mentoring, Online Training, Training Services
"/>
...
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
 <link rel="canonical" href="https://www.coepd.us/about-us.html" />
	...
	<div class="row">
		<div class="col-sm-12 col-md-7 col-lg-9 col-xl-9">
			<div class="page-content1">
				<p>Our Team will help you for invest money to get profits .</p>
				<p>We as a team take care of trading .</p>
				<b>Our Vision : </b><p>Effective and safe.</p>
				<b>Consultant :</b><p> Show your ledger reports.</p>
				<b>Knowledge sharing : </b><p>Regarding shares.</p>
				<p><strong>Analysis</strong> Customers and Consultant <strong>To make profit.</strong></p>
				<b>Recognition:</b>
				<p>We are recognized by <strong>with Id</strong> promising in creating ledger <strong> Pay In and Pay Out -2021</strong></p>
				<img src="img/Silicon-India.jpg" class="img-responsive" height="515" width="625" alt="Silicon India Certificate" style=" display: block;margin-left: auto;margin-right: auto;"/>
			</div>
		</div>
		<div class="col-sm-12 col-md-5 col-lg-3 col-xl-3 floating-box"> 
			...
			<div class="floating-box1">
				<b><center>Trading Calender</center></b>
				<?php echo ($news['newsDescription']); }?> 
			</div>
			<div class="floating-box2">
					<b style="font-family:callibri;font-size:30px;color:#CD7F32;"><center>Some Bonds</center></b>
					<ul class="quick-links">
					<!-- Trigger the modal with a button -->
						<li><a data-toggle="modal" data-target="#quick">Who is a CUSTOMER?</a></li>						
							  <!-- Modal -->
							  <div class="modal fade" id="quick" role="dialog" tabindex="-1">
								<div class="modal-dialog modal-lg">
								  ...
								  <div class="modal-content">
									<div class="modal-header">
									  <p class="modal-title">Who is a CUSTOMER?</p>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
									  <p>Some one how can invest money to buy shares and sell the shares to get profits (and can able to veiw reports and ledger).</p>
									</div>
								  </div>
								  
								</div>
							  </div>						
						<li><a data-toggle="modal" data-target="#quick1">Where and what is the importance for Customer ? </a></li>
						 <!-- Modal -->
							  <div class="modal fade" id="quick1" role="dialog" tabindex="-1">
								<div class="modal-dialog modal-lg">
								  ...
								  <div class="modal-content">
									<div class="modal-header">
									  <p class="modal-title">Where and what is the importance for customer ? </p>
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>
									<div class="modal-body">
									  <b>Transactions</b>
									  <ul class="quick1">
										<li>Transaction Id, It provides an accurate record of all financial transactions. It helps you compile a trial balance, so your books balance. It makes filing tax returns easy because you have expenses and income is in one place.</li>
										<li>It provides an accurate record of all financial transactions. It helps you compile a trial balance, so your books balance. It makes filing tax returns easy because you have expenses and income is in one place.</li>
										<li>A ledger account contains a record of business transactions. It is a separate record within the general ledger that is assigned to a specific asset, liability, equity item, revenue type, or expense type.</li>
									  </ul>
									</div>
								  </div>
