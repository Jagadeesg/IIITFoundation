...
if(isset($_POST['reqdemo_btn']))
{
	...
	$country=$country.$phone;
			...
			{
				echo "<script>
				window.location.href='Certified-IT-Business-Analyst-practitioner-professional.php';
			</script>";
			}
			else
			{
...
<html>
	<head>
		<title>Certified IT Business Analyst Practitioner | CITBAP | IIBA</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta name="keywords" content="certified IT business analyst practitioner,citbap,ba certification,certified business analysis professional,ivy global Academy,iiba certification,business analyst certification online,it business analyst certification,business analyst certification."/>
		<meta name="description" content="COEPD BA Training gives eligibility for Certified IT Business Analyst Practitioner – CITBAP, an international prestigious Recognition for BA’s."/>
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
 <link rel="canonical" href="https://www.coepd.us/certified-it-business-analyst-practitioner.html" />
...
<div class="col-md-12 ">
		...
		<textarea id="message1" name="subject" placeholder="Write something.." required style="height:100px" ></textarea><br>
	</div>
	 ...
	 <div class="container-fluid page-heading">
		<div class="row">
			<h1>CERTIFIED IT BUSINESS ANALYST PRACTITIONER (CITBAP)</h1>
		</div>
	</div> 
	...
	<div class="row">
		<div class="col-sm-12 col-md-7 col-lg-9 col-xl-9">
			<div class="page-content1">
				<b>Certified IT Business Analyst Practitioner(CITBAP)</b>
				<p><strong>Exam Code : </strong>CITBAP</p>
				<p><img src="img/CITBAP.png" class="img-fluid" alt="CITBAP"/></p>
				<strong>About Exam Course</strong>
				<p>This certification is a prestigious Recognition for Professionals who have the capability to drive IT Projects and implement at the Clients place. With this certification you can showcase eight skill areas like BA Directives, BA Competencies, Software Development life Cycles like Sequential, Agile and Scrum, Functional Skills using Domain modelling and applying Business Process Model, understanding the technical side through Object Oriented Approach (OOA) and communicating Requirements through Unified Modelling Language (UML), preparing Documents like Business Requirements Document (BRD), Functional Spec, Requirements Traceability Matrix (RTM) , Project Closure Documents, User Manuals, Fit for Support Documents and Lesson learned Documents and Usage of tools for Documentation, UML drawing and Wireframes and prototyping tools , Requirements Engineering and BA Strategy.</p>
				<strong>Target Audience</strong>
				<p>For all the Professionals who are playing the role of BA without having a BA designation and are contributing in the project management, Quality, requirements engineering, Testing etc, the best option is to get certified as CITBAP to get into next levels of BA.</p>
				<strong>Register for Exam </strong>
				<p>CITBAP - Certified IT BA Practitioner – USD 149</p>
				<center><img src="img/Certificate-CITBAP.jpg" alt="CITBAP-Certificate" width="600px" class="img-fluid"/></center>
				</div>
		</div>
