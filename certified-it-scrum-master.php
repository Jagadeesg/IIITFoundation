...
if(isset($_POST['reqdemo_btn']))
{
	...
	$country=$country.$phone;
		...
		$register="insert into request_demo(name,email,country,subject,DateTime) 
			...
			{
				echo "<script>
				window.location.href='Certified-IT-Scrum-Master.php';
			</script>";
			}
			else
			{
...
<html>
	<head>
		<title>Certified IT Scrum Master | CITSM | IIBA Certificate</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta name="keywords" content="Certified IT Scrum Master,CITSM,IIBA Certificate,scrum master certification,agile scrum master certification,scrum master training,scrum training,agile scrum master,scrum certification,iiba certification."/>
		<meta name="description" content="CITSM - Certified IT Scrum Master, an Internationally Recognised Certificate, enables to manage Scrum team and Successfully implement a Scrum Project"/>
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
 <link rel="canonical" href="https://www.coepd.us/certified-it-scrum-master.html" />
...
<div class="col-md-12 ">
	 ...
	 <div class="container-fluid page-heading">
		<div class="row">
			<h1>CERTIFIED IT SCRUM MASTER (CITSM)</h1>
		</div>
	</div> 
	...
	<div class="row">
		<div class="col-sm-12 col-md-7 col-lg-9 col-xl-9">
			<div class="page-content1">
			   <p><b>Certified IT Scrum Master (CITSM)</b></p>
               <strong>Exam Code : </strong>CITSMP0001<hr>
               <p><img src="img/CITSM.png" alt="CITSM" class="img-fluid"/></p>
                <strong>About Exam Course</strong>
                <p>Scrum Master facilitates the product development team which follows scrum frame work. He takes care of how the information is exchanged. Many assume that Scrum Master and Project Manager are same, realistically both have no connection. The project manager manages the project and the team and is accountable to achieve project objectives and is the sole decision maker. The Scrum Master is who acts as a facilitator between the project and the customer but never manages a team and is similar to that of a coach. He coaches the team, supports the product owner and makes sure that the processes of Scrum are followed to retain customer satisfaction and confidence.</p>
                <strong>Target Audience</strong>
                <p>Scrum Master training is especially appropriate for anyone in the corporate structure dealing with rapidly changing demands and decision-making responsibilities. In a traditional organization, these roles might include: </p>
                <ul>
                  	<li>Stakeholders</li>
                ...
                <p>CITSM - Certified IT Scrum Master – USD 119</p>
               <img src="img/CertificateCITSM.jpg" alt="CITSM Certificate" width="600" class="img-fluid" style=" display: block;margin-left: auto;margin-right: auto;"/>
			</div>
		</div>
