...
<html>
	<head>
		<title>FAQ | Frequently Asked Questions | BA Training</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta name="keywords" content="BA frequently Asked Questions,BA FAQ, BA Interview questions."/>
		<meta name="description" content="COEPD clarifies all possible queries of BA Aspirants about BA Training, Eligibility, Course Content, Trainers, Projects and Payments through FAQs. "/>
<meta name="msvalidate.01" content="41D3FCA23F7ECCC428300B28659B5E4A" />
 <link rel="canonical" href="https://www.coepd.us/faqs.html" />
...
<script type="text/javascript">
   ...
   <script type="text/javascript">
     function reqdemo()
     {
      alert("Your Details are Inserted Successfully");
...
<div class="demo2" id="demo2">
	<div class="container demo-container">	
	  ...
	  <form  name="request_demo" method="post" id="location"  onsubmit="reqdemo()">
	  	...
	  	<div class="col-md-12 ">
	  			<label for="name">Name:<span class="demostar">*</span></label>
		<input type="text" id="name1" name="name" placeholder="Your name.." required></div>
		<div class="col-md-12 ">
		<label for="email">Email Address:<span class="demostar">*</span></label>
	...
	<div class="row">
		...
		<label>Country:<span class="demostar">*</span></label>
			...
			<div class="col-md-6">
	     <label for="phone">Phone number:<span class="demostar">*</span></label><br>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-7 col-lg-9 col-xl-9">
			<div id="myaccordion">
				<!-- accordion 1 -->
				<p>What is Business Analysis ?</p>
				<div>
					Business Analysis is in two specializations which will cover 360 degrees. Identify/Analyze the Business opportunities and problems in particular domain or vertical Implementing IT Solutions with the help of Technical Team Bridging the gap between Client Business Needs& Technical solutions.
				</div>
				<!-- accordion 2 -->
				<p>Who can join BA training?</p>
				<div>
					Any professional with Good Communication Skills, peoples management skills and who have Minimum Domain Experience/Knowledge.
				</div>
				<!-- accordion 3 -->
				<p>Do we need technical skills for a BA?</p>
				<div>
					Not required, It is purely a Non Technical Role in an IT industry, If you have any technical knowledge that is an added advantage.
				</div>
				<!-- accordion 4 -->
				<p>What is Mentoring program?</p>
				<div>
					Mentoring program is where our mentors will take personal care in mentoring participants to get more access to practice and awareness on the skill set of Business analysis that will help you to successfully achieve a job.
				</div>
				<!--accordian 5-->
				<p>Can I attend a demo class before joining the training?</p>
				<div>
					Yes, you can attend free demo class by clicking on Request for Demo or Contact +1 (469) 287-7949
				</div>
				<!--accordian 6-->
				<p>How are the online classes conducted?</p>
				<div>
					Online classes are conducted using Skype/WebEx/GoToMeeting. You will be sent a new meeting link for every session.
				</div>
				<!--accordian 7-->
				<p>Things required for the BA online training?</p>
				<div>
					You will need a computer with high speed internet connection, headsets with microphone, papers and a pen to jot down imp notes and diagrams and most importantly a fresh mind.
				</div>
				<!--accordian 8-->
				<p>Can I join other batches if i missed out any classes?</p>
				<div>
					Yes, you can join the other batches if you have missed out on any of the classes.
				</div>
				<!--accordian 9-->
				<p>Where can i get the course syllabus?</p>
				<div>
					Please request for the course details. Contact +1 (469) 287-7949/Email trainings@coepd.us
				</div>
				<!--accordian 10-->
				<p>What is the fee for the courses?</p>
				<div>
					Please request for the fee details. Contact +1 (469) 287-7949/Email trainings@coepd.us
				</div>
				<!--accordian 11-->
				<p>Are the Employees experienced?</p>
				<div>
					Our Employees are industry experts having more than a decade of work experience in handling IT projects in the ranks of a Project Manager, Principal Business Analyst , Senior Business Analyst and CIO.
				</div>
				<!--accordian 12-->
				<p>How to participate in blogs, forums and online prep exams?</p>
				<div>
					Once you have enrolled with COEPD, we will provide you the login credentials to our web portal to get access to blogs, forums and prep exams.
				</div>
				<!--accordian 13-->
				<p>Will you help with tools installation?</p>
				<div>
					If you have a hard time installing we will assist you online.
				</div>
				<!--accordian 14-->
				<p>Do we get to work on a project?</p>
				<div>
					Yes, we will make you work on one of the project end to end.
				</div>
				<!--accordian 15-->
				<p>Do you help with resume preparation?</p>
				<div>
					Yes, after the training is completed we assist you in Resume preparation..
				</div>
				<!--accordian 16-->
				<p>Can i make an online payment if i am interested to join the training?</p>
				<div>
					Yes you can make an online payment by clicking on online payment tab or request for Bank details to make a transfer.
				</div>

				<!--accordian 17-->
				<p>What credit cards are accepted online?</p>
				<div>
					We accept all major credit card types Visa,Master,Discover and American Express.
				</div>
				<!--accordian 18-->
				<p>What are the payment modes you accept?</p>
				<div>
					Pay by using Credit/Debit card with online payment tab on our website or bank transfer to Wells Fargo account. Contact us at 
+1 (469) 287-7949/trainings@coepd.us for further details.
		...
		<div class="col-xs-12 col-sm-12 col-md-5 col-lg-3 col-xl-3 floating-box"> <?php
			include("dbconnect.php");
