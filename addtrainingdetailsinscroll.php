...
if(isset($_POST['batch_btn']))
{
    ...
    $dt= date('Y-m-d H:i:s');
    $insert="insert into scrolltrainingdetails_tbl( trainingdetails_text,DateTime) values('$training_text','$dt')";
        $data=mysqli_query($conn,$insert);
        if($data)
        {
        echo "<script>
         alert ('Scroll Training Details added successfully');
            window.location.href='addtrainingdetailsinscroll.php';
        </script>";
        }
        else{
            echo "<script>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-primary" style="background-color: #f9f9f9;">
                           ...
                           <h4>Add Scroll Training Details</h4></div>
                            <div class="panel-body">
                                <form class="form-horizontal" method="POST"  >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="training_text" class="form-control" style="height:200px;width:470px;" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-4">
                                            <input type="submit" name="batch_btn" class="btn btn-primary" value="Add">
